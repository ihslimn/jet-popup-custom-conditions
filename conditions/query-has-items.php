...
if ( ! defined( 'WPINC' ) ) {
	 ...
	 */
	class Jet_Popup_Conditions_Advanced_Query_Has_Items extends Jet_Popup_Conditions_Base {
		...
		public function get_label() {
			return __( 'JetEngine Query Has Items', 'jet-popup' );
		}
